  ...
  return (
    <section className="relative h-screen md:h-screen w-full flex items-end overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Desktop Image */}
        <Image 
          src={content?.image_url || "https://images.unsplash.com/photo-1514066558159-fc8c737ef259?q=80&w=1974&auto=format&fit=crop"} 
          alt={content?.title || "Kids' Collection Desktop"}
          fill
          priority
          className={cn(
        ...
        {content?.mobile_image_url && (
          <Image 
            ...
            alt={content?.title || "Kids' Collection Mobile"}
            fill
            priority
            className="object-cover brightness-[0.8] block md:hidden"
            sizes="100vw"
          />
        )}
      ...
      <div className="relative z-10 w-full px-6 md:px-20 pb-24 md:pb-32 animate-in fade-in slide-in-from-bottom-12 duration-1000">
        <div className="max-w-4xl space-y-8">
          <p className="text-[10px] md:text-[11px] font-bold tracking-[0.5em] uppercase text-white/90">
            {content?.subtitle || 'THE EDITORIAL SERIES / 08'}
          </p>
